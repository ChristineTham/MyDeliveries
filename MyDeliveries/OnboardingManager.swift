...
class OnboardingManager {
    ...
    private func configuredWelcomeScreenStep() -> WelcomeScreenStep {
        ...
        welcomeScreenStep.welcomeScreenCustomizationHandler = { welcomeStepUI in
            ...
            if let welcomeScreen = welcomeStepUI as? FUIWelcomeScreen {
                ...
                welcomeScreen.emailTextField.text = "user@trial-s0019995101trial.sapmobileplace.com"
            }
        }
    ...
    private func configuredUserConsentStep() -> UserConsentStep {
        ...
        mpPageContent1.actionTitle = actionTitle
        mpPageContent1.actionUrl = actionUrl
        ...
        mpPageContent2.actionTitle = actionTitle
        mpPageContent2.actionUrl = actionUrl
        ...
        mpPageContent3.actionTitle = actionTitle
        mpPageContent3.actionUrl = actionUrl
